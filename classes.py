...
basic_enemies = {'goblin': Enemy('Гоблин', 20, 4, 4, ['phys'],
                                 {'fire': 0.9, 'water': 0.9, 'electro': 0.9, 'poison': 0.9, 'curse': 0.9, 'phys': 0.9,
                 ...
                 'leshii': Enemy('Леший', 80, 15, 10, ['poison', 'phys'],
                                 {'fire': 0.5, 'water': 1, 'electro': 0.7, 'poison': 1, 'curse': 10, 'phys': 2,
                                  'space': 1.3, 'ice': 1, 'heal': 0, 'melee': 1}, {'Ветка': 100, 'Ядовитый инврис': 50},
                                 200, True),
                 ...
                 'gorgon': Enemy('Медуза Горгона', 140, 15, 0, ['curse'],
                                           {'fire': 1, 'water': 1, 'electro': 0.7, 'poison': 0.7, 'curse': 1.5,
                                            'phys': 0.75, 'space': 0.75, 'ice': 1, 'heal': 0, 'melee': 1.5},
                 ...
                 'flower-fairy': Enemy('Дух цветов', 50, 8, 10, ['fire','water','ice','electro'],
                                           {'fire': 1.1, 'water': 1.1, 'electro': 1.2, 'poison': 0.7, 'curse': 0.7,
                                            'phys': 0.75, 'space': 0.6, 'ice': 1.1, 'heal': 0, 'melee': 1},
                 ...
                 'mandragora': Enemy('Мандрагора', 90, 7, 15, ['phys'],
                                           ...
                                           {'Желтый инврис':50,'Коренб мандрагоры':40}, 140, False),
                 'flower-fairy-king': Enemy('Король духов цветов', 290, 10, 15, ['fire','water','ice','electro'],
                                           ...
                                           {'Огненный инврис': 30,'Ледяной инврис': 20,'Электрический инврис': 15,
                                            'Призмариновый инврис': 15,'Проклятый огненный инврис':10}, 290, False),
                 'dryad': Enemy('Древесный живой инврис', 200, 15, 20, ['electro','poison','phys'],
                                ...
                                200, False),
                 'envrisent': Enemy('Инврисэнт', 300, 25, 20, ['curse','poison','phys'],
                                {'fire': 0.8, 'water': 1, 'electro': 1.2, 'poison': 0.7, 'curse': 1.2,
                                 'phys': 0.5, 'space': 0.9, 'ice': 1, 'heal': 0, 'melee': 1},
                                {'Проклятый ядовитый инврис': 50,'Проклятый инврис': 45,'Желтый инврис': 25},
                                500, False),
                 'elder-envrisent': Enemy('Древний инврисэнт', 500, 20, 30, ['curse','poison','phys'],
                                ...
                                800, True),
                 'distortion-envrisent': Enemy('Искаженный инврисэнт', 250, 25, 25, ['electro','fire','poison','phys'],
                                ...
                                550, False),
                 'fused-distortion-envrisent': Enemy('Сросшиеся искаженные инврисэнты', 600, 17, 55,
