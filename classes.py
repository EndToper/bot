...
drop_cost = {"Коготь":60,"Желтый инврис":20,"Шкура волка":70,"Ветка Лешего":1000,"Ядовитый инврис":20,"Слеза водного духа":360,
             ...
             'Воспламенившийся инврис':10000,'Проклятый ядовитый инврис':450,'Пространственный инврис':4000,
...
basic_enemies = {'goblin': Enemy('Гоблин', 20, 4, 4, ['phys'],
                 ...
                 'siren': Enemy('Сирена', 140, 12, 15, ['water'],
                 ...
                 'long-necked-sea-serpent': Enemy('Длинношеий морской змей', 70, 20, 12, ['water'],
                 ...
                 'gorgona': Enemy('Медуза Горгона', 300, 30, 2, ['curse'],
                                           {'fire': 1, 'water': 1, 'electro': 0.7, 'poison': 0.7, 'curse': 1.5,
                                            'phys': 0.7, 'space': 0.75, 'ice': 1, 'heal': 0, 'melee': 1.5},
                                           {'Призмариновый инврис': 80, 'Жидкость окаменения': 75,'Демонический инврис':30}, 500,
                                           False),
                 ...
                 'flower-fairy-king': Enemy('Король духов цветов', 290, 20, 15, ['fire','water','ice','electro'],
                                           ...
                                           {'Огненный инврис': 70,'Ледяной инврис': 50,'Электрический инврис': 40,
                                            'Призмариновый инврис': 55,'Проклятый огненный инврис':50}, 290, False),
                 'dryad': Enemy('Древесный живой инврис', 400, 25, 20, ['electro','poison','phys'],
                                ...
                                200, False),
                 'envrisent': Enemy('Инврисэнт', 600, 35, 20, ['curse','poison','phys'],
                                {'fire': 0.8, 'water': 1, 'electro': 1.2, 'poison': 0.7, 'curse': 1.2,
                                 'phys': 0.5, 'space': 0.9, 'ice': 1, 'heal': 0, 'melee': 1},
                                {'Проклятый ядовитый инврис': 50,'Проклятый инврис': 45,'Желтый инврис': 25},
                                500, False),
                 'elder-envrisent': Enemy('Древний инврисэнт', 700, 50, 30, ['curse','poison','phys'],
                                ...
                                800, True),
                 'distortion-envrisent': Enemy('Искаженный инврисэнт', 750, 35, 25, ['electro','fire','poison','phys'],
                                ...
                                550, False),
                 'fused-distortion-envrisent': Enemy('Сросшиеся искаженные инврисэнты', 1000, 50, 55,
                                ...
                                900, False),
                 'stonlem': Enemy('Камнелем', 80, 12, 40, ['phys'],
                                ...
                                190, False),
                 'salamandra': Enemy('Саламандра', 240, 20, 40, ['phys','fire'],
                                ...
                                290, False),
                 'anchimayen': Enemy('Анчимайен,', 440, 35, 25, ['phys','electro'],
