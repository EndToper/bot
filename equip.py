...
weapons = [Equip(0, ['phys', 'melee'], 1, 12, 'Старый меч', 0, 'bod', 1, None, 0),
           ...
           Equip(0, ['space', 'electro', 'phys', 'poison'], 5, 30, 'Электроарбалет с ядовитыми стрелами', 25, 'dex', 2.5,
           ...
           Equip(0, ['phys', 'electro'], 4, 30, 'Электромагическая винтовка', 25, 'dex', 1,
                 ['Электрический инврис', 'Электрический инврис', 'Электрический инврис', 'Электрический инврис',"Ядро","Ядро"], 4),
           ...
           Equip(0, ['phys', 'poison','electro','space','curse'], 6, 40, 'Ядовитая винтовка', 50, 'bod', 1,
                 ["Ядро","Ядро","Ядро",'Ядовитый инврис','Ядовитый инврис','Ядовитый инврис','Электрический инврис','Электрический инврис','Проклятый огненный инврис','Желтый инврис','Желтый инврис','Желтый инврис'], 4),
