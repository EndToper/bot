...
weapons = [Equip(0, ['phys', 'melee'], 1, 12,'Старый меч',0,'bod',1,None),
           ...
           Equip(0, ['phys', 'melee','poison'], 3, 30, 'Ядовитый меч', 15, 'bod', 1, ['Ядовитый инврис']),
           Equip(0, ['phys', 'melee','fire'], 3, 30, 'Огненный меч', 15, 'bod', 1, ['Огненный инврис']),
           Equip(0, ['phys', 'melee','electro'], 4, 30, 'Магический меч', 25, 'bod', 1, ['Электрический инврис']),
           ...
           Equip(0, ['phys', 'melee','space'], 7, 30, 'Пространственный меч', 50, 'bod', 1, ['Пространственный инврис','Пространственный инврис']),
           Equip(0, ['phys', 'melee','curse'], 3, 30, 'Проклятый меч', 25, 'bod', 1, ["Проклятый инврис"]),
           Equip(0, ['phys', 'melee','poison'], 5, 30, 'Сильно ядовитый меч', 35, 'bod', 1, ["Проклятый ядовитый инврис"]),
           Equip(0, ['phys', 'melee','ice'], 5, 30, 'Ледяной меч', 25, 'bod', 1, ["Ледяной инврис"]),
