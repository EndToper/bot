...
weapons = [Equip(0, ['phys', 'melee'], 1, 12, 'Старый меч', 0, 'bod', 1, None, 0),
           ...
           Equip(0, ['phys', 'poison','electro','curse'], 6, 35, 'Ядовитая винтовка', 50, 'bod', 1,
                 ["Ядро","Ядро","Ядро",'Ядовитый инврис','Ядовитый инврис','Ядовитый инврис','Электрический инврис','Электрический инврис','Проклятый огненный инврис','Желтый инврис','Желтый инврис','Желтый инврис'], 6),
