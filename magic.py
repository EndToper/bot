...
spell = [MagicType(['fire'],1,'fireball','Огненный шар',0, 0,'int'),
         ...
         MagicType(['space','fire','electro'],3,'fire_electro_arrow','Огненная электрострела',10,4,'int'),
         ...
         MagicType(['space','melee'],9,'space_slice','Разруб пространства',40,9,'int'),
         MagicType(['space'],11,'space_boom','Взрыв пространства',50,11,'int'),
         MagicType(['space'],14,'space_deformation','Искажение пространства',60,13,'int'),
         MagicType(['space'],16,'space_collapse','Коллапс пространства',70,16,'int'),
