...
spell = [MagicType(['fire'], 1, 'fireball', 'Огненный шар', 0, 0, 'int'),
         ...
         MagicType(['ice', 'poison'], 5, 'poisoned_ice_arrow', 'Отравленная ледяная пуля', 30, 25, 'int'),
         ...
         MagicType(['space', 'fire', 'electro'], 3, 'fire_electro_arrow', 'Огненная электрострела', 10, 12, 'int'),
         MagicType(['space', 'curse', 'poison', 'melee'], 4, 'poison_cursed_sword', 'Проклятый ядовитый меч', 20, 25,
                   'int'),
         MagicType(['space', 'ice', 'electro'], 5, 'space_attack', 'Пространственный удар', 30, 36, 'int'),
         MagicType(['space', 'melee'], 8, 'space_slice', 'Разруб пространства', 40, 32, 'int'),
         MagicType(['space'], 10, 'space_boom', 'Взрыв пространства', 50, 36, 'int'),
         MagicType(['space'], 13, 'space_deformation', 'Искажение пространства', 60, 40, 'int'),
         MagicType(['space'], 15, 'space_collapse', 'Коллапс пространства', 70, 44, 'int'),
         ...
         MagicType(['space', 'heal', 'curse'], 5, 'evil_heal', 'Нечистивое исцеление', 80, 5, 'int'),
         MagicType(['space', 'heal', 'poison'], 7, 'vampire_heal', 'Вампирское исцеление', 90, 10, 'int'),
         MagicType(['space', 'heal', 'fire'], 10, 'ignite_heal', 'Пылающее исцеление', 100, 10, 'int')]
