...
locations = [Location('town', ['path'], 'Торговый город', ['Тропинка к городу']),
             ...
             Location('dark-forest',['dark-envris-forest','dark-forest2','forest'],'Темный лес',['Темный инврисовый лес',
                                                                                                 'Темный лес','Лес']),
             Location('dark-envris-forest',['dark-forest2','dark-forest','portal'],'Темный инврисовый лес',['Темный лес',
                                                                                                            'Темный лес',
                                                                                                            'Прогуляться по лесу']),
             Location('portal',['dark-envris-forest','portal2'],'Портал',['Вернуться','Войти в портал']),
             Location('portal2',['portal'],'Скоро...',['Вернуться']),
             Location('dark-forest2',['forest','dark-forest','dark-envris-forest'],'Темный лес',['Лес','Темный лес','Темный инврисовый лес']),
             Location('path4',['seaside2','forest2','path5','forest'],'Тропинка к морю',['Скалистое побережье','Перелески','Тропинка к побережью','Лес']),
             ...
             Location('seaside-town',['seaside2','seaside'],'Прибрежный город',['Скалистое побережье','Побережье']),
             Location('seaside2',['rocks','seaside-town','path5'],'Скалистое побережье',['Скалы','Прибрежный город','Тропинка к морю']),
             Location('rocks',['path3','seaside2'],'Скалы',['Тропинка к скалам','Побережье']),
